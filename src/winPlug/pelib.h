...
protected:
	...
	PIMAGE_NT_HEADERS64		image_nt_headers;
...
public:
	...
	PIMAGE_SECTION_HEADER AddNewSection(const char* szName, DWORD dwSize, void *pData = NULL);
	PIMAGE_SECTION_HEADER GetSectionHeader(const char *cszName);
	PCHAR GetSectionData(const char *cszName);
