...
enum eParserOperator{
	...
	E_OP_REMOTE_CALL, //Call function from other module format: module-name, func-name,args
...
protected:
	...
	//LogicDataObj* _refVariant(runningStack *stack, char *&pCmdStream);
	...
	bool _getVarEx(runningStack *stack, const char *inputVarName, LogicDataObj &outVar);//reference variant or sub variant 

	//int _readGameDataTable(runningStack *stack, char *pCmdStream, LogicDataObj &outValue);
